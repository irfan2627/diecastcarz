...
const about_page = async(req,res) => {
    ...
    if (!cart) {
      cart = new Cart({ userId: userData, products: [] });
        ...
        res.render('about_page', { categories,cart})
    } catch (error) {
...
const contact_page = async(req,res) => {
    ...
    if (!cart) {
      cart = new Cart({ userId: userData, products: [] });
        ...
        res.render('contact_page', { categories,cart})
    } catch (error) {
...
const terms_page = async(req,res) => {
    ...
    if (!cart) {
      cart = new Cart({ userId: userData, products: [] });
        ...
        res.render('terms_page', { categories,cart})
    } catch (error) {
...
const privacy_policy_page = async(req,res) => {
    ...
    if (!cart) {
      cart = new Cart({ userId: userData, products: [] });
        ...
        res.render('privacy_policy_page', { categories,cart})
    } catch (error) {
